                     ...
                     if (fread(&conta_poupanca, sizeof(conta_poupanca), 1, arquivo)) // le as contas do arquivo até chegar ao final ou acontecer algum erro
                        {
  	                       if (conta_poupanca.senha == senha && conta_poupanca.excluido == 0)
		                      {
		                        if(strcmp(conta_poupanca.limite, "Conta sem limite") == 0)
		                          {							      	
							        printf("\nLIMITE INDISPONIVEL\n");
							        ...
							        encontrado = 1;
		  	                       ...
		  	                       {								
						             printf("\nLIMITE DISPONIVEL: R$%s\n", conta_poupanca.limite);
						             encontrado =1;
						             break; 
						           }
		                     }
      ...
      switch(opcao)
       {
        ...
        printf("\n\n");
     	printf("\n                                                   d8888 8888888b.   .d8888b.        888888b.          d8888 888b    888 888    d8P  ");
		printf("\n                                                  d88888 888   Y88b d88P  Y88b       888   88b        d88888 8888b   888 888   d8P   ");
		printf("\n                                                 d88P888 888    888 Y88b.            888  .88P       d88P888 88888b  888 888  d8P    ");
		printf("\n                                                d88P 888 888    888   Y888b.         8888888K.      d88P 888 888Y88b 888 888d88K     ");
		printf("\n                                               d88P  888 888    888      Y88b.       888   Y88b    d88P  888 888 Y88b888 8888888b    ");
		printf("\n                                              d88P   888 888    888        888       888    888   d88P   888 888  Y88888 888  Y88b   ");
		printf("\n                                             d8888888888 888  .d88P Y88b  d88P       888   d88P  d8888888888 888   Y8888 888   Y88b  ");
		printf("\n                                            d88P     888 8888888P     Y8888P         8888888P   d88P     888 888    Y888 888    Y88b ");  
